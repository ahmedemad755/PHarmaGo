...
class ProductsCubit extends Cubit<ProductsState> {
  ProductsCubit({
    ...
    required GetBestSellingProductsUseCase getBestSellingProductsUseCase,
  }) : _getProductsUseCase = getProductsUseCase,
       _getBestSellingProductsUseCase = getBestSellingProductsUseCase,
  ...
  void fetchBestSelling({int topN = 10}) {
    ...
    _bestSellingSubscription = _getBestSellingProductsUseCase(
      topN: topN,
    ).listen((result) {
      result.fold(
