...
import 'package:e_commerce/Features/best_selling_fruites/presentations/views/widgets/notifecation_widgets.dart';
      ...
      trailing: BlocBuilder<OrdersCubit, OrdersState>(
        builder: (context, state) {
          ...
          if (state is OrdersSuccess && state.hasNotification) {
            displayCount =
                1; // سيظهر الرقم 1 أو نقطة حمراء كدليل على وجود تحديث
          }
