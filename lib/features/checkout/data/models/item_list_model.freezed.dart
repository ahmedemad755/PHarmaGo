...
abstract class $ItemListModelCopyWith<$Res> {
  factory $ItemListModelCopyWith(
    ItemListModel value,
    $Res Function(ItemListModel) then,
...
abstract class _$$ItemListModelImplCopyWith<$Res>
  ...
  factory _$$ItemListModelImplCopyWith(
    _$ItemListModelImpl value,
    $Res Function(_$ItemListModelImpl) then,
...
class __$$ItemListModelImplCopyWithImpl<$Res>
  ...
  __$$ItemListModelImplCopyWithImpl(
    _$ItemListModelImpl _value,
    $Res Function(_$ItemListModelImpl) _then,
  ) : super(_value, _then);
...
class _$ItemListModelImpl implements _ItemListModel {
  const _$ItemListModelImpl({required final List<ItemModel> items})
    : _items = items;
  ...
  Map<String, dynamic> toJson() {
    return _$$ItemListModelImplToJson(this);
  }
}

abstract class _ItemListModel implements ItemListModel {
  const factory _ItemListModel({required final List<ItemModel> items}) =
      _$ItemListModelImpl;
